...
import TempChart2 from "../Components/TempChartComman";
import TempChart from "../Components/TempChart";
import TempChartLine from "../Components/TempChartLine";
import TempChartLine2 from "../Components/TempChartLine2";
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center items-center">
            {data.map((item, index) => (
              ...
              <div className="pt-6 pl-6 w-full">
                <Paper sx={{background:"background.custom1",borderRadius:"12px"}} className="mb-6 text-[#344767] rounded-xl">
                    ...
                    <div className=" flex flex-col shadow-sm md:shadow-md lg:shadow-lg rounded-xl" >
                      <div className="p-4 text-[20px] leading-[1.625] tracking-[0.00938em] rounded-xl">
          ...
          <div className="flex flex-col md:flex-row basis-4/5">
            <div className="pt-[24px] pl-[24px] w-full md:w-1/2 h min-[992px]:w-2/3 ">
              <Paper sx={{background:"background.custom2",borderRadius:"12px"}} className="mb-3 bg-[#f0f2f5] rounded-xl ">
            ...
            <Paper sx={{background:"background.custom2",borderRadius:"12px"}} className="mb-3 h-full bg-white">
