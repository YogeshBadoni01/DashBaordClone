                        ...
                        <div className="mb-3 bg-[#f0f2f5] ">
                          <div className="shadow-sm md:shadow-md lg:shadow-lg rounded-xl bg-white">
                            <div className="flex flex-col px-4 pt-2 justify-between  ">
                              ...
                              <div className="">
                                  <span className='text-[14px] leading-[1.5] tracking-[0.399px] text-[#7b809a] font-light '>heading</span>
                                  <h4 className='text-[24px] leading-[1.375] font-bold text-[#344767]'>NumberOfItem</h4>
                              </div>
                            </div>
