  ...
  [
    {
        LinName:"Dashboard",
        Link:"./Dashboard",
        Icon:<MdDonutLarge className='w-[20px] h-[20px] ' />,
    },
    {
      LinName:"Profile",
      Link:"./Dashboard/Profile",
        Icon:<MdPerson className='w-[20px] h-[20px] ' />,
    },
    {
      LinName:"Sign Up",
      Link:"./SignUp",
    ...
    },
    {
      LinName:"Sign In",
      Link:"./SignIn",
        Icon:<MdKey className='w-[20px] h-[20px] ' />,
  },
]
    ...
    <Box sx={{ flexGrow: 1 }} className="">
      ...
      <div className='rounded-xl' >
        ...
        <div className="flex justify-between items-center w-full ">
          ...
          <h6 className='text-[14px]  leading-[1.5] Tracking-[0.02857em] font-bold'>
          ...
          <ul className='md:flex hidden '>
                {
                    data.map((item,index)=>(
                        ...
                        <li key={index} className='flex items-center text-[14px]  leading-[1.5] Tracking-[0.02857em] mx-2 p-2'>{item.Icon}
                          <span className='' >&nbsp;{item.LinName}</span>
                          </li>
                         </Link>
                    ))
                }
          ...
          <button className='hidden md:block px-4 py-1.5  mt-[-2.4px] cursor-pointer align-middle leading-[1.4] Tracking-[0.02857em] min-w-[64px] font-bold rounded-lg min-h-[32px] text-[12px] uppercase' style={{background:'linear-gradient(195deg, rgb(73, 163, 241), rgb(26, 115, 232))'}}>Free Download</button>
        </div>
