      ...
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        <TableHead>
          <TableRow className='uppercase'>
            <TableCell><span className="px-2 py-1.5 text-[10px] block text-[#7b809a] uppercase font-bold opacity-75">Projects</span></TableCell>
            <TableCell align="left"><span className="px-2 py-1.5 text-[10px] block text-[#7b809a] uppercase font-bold opacity-75">budget</span></TableCell>
            <TableCell align="center"><span className="px-2 py-1.5 text-[10px] block text-[#7b809a] uppercase font-bold opacity-75">status</span></TableCell>
            <TableCell align="center"><span className="px-2 py-1.5 text-[10px] block text-[#7b809a] uppercase font-bold opacity-75">completion</span></TableCell>
            <TableCell align="center"><span className="px-2 py-1.5 text-[10px] block text-[#7b809a] uppercase font-bold opacity-75">action</span></TableCell>
        ...
        <TableBody>
          {rows.map((row,index) => (
            ...
            >
              <TableCell component="th" scope="row" className=' flex items-center px-6 py-3 bottom-0 w-[30%]'>
                <div className="flex items-center">
                    <img src={`Images/Dashboard/${row.brand}.svg`} alt="" className=" w-[36px] h-[30px] p-1" />
                    <span className='ml-2 capitalize leading-none text-[#344767] font-semibold tracking-[0.028rem]'>{row.brand}</span>
                </div>
              </TableCell>
              <TableCell align="left" className='px-6 py-3 text-[#7b809a] leading-normal font-semibold  '>
                <span>${row.budget}</span>
              </TableCell>
              <TableCell align="right" className='px-6 py-3 text-[#7b809a] leading-[1.625] font-semibold  text-center text-[12px]'>
              ...
              <TableCell align="right" className='px-6 py-3 ' >
                ...
                <span className='block text-[#7b809a] leading-[1.625] font-semibold'>
                    {row.completion[0]}%
                </span>
              ...
              <TableCell  className='px-6 py-3 text-center  '>
                    <Link href="./Dashboard" className=' text-[#7b809a] no-underline text-[20px] flex justify-center items-center'>
